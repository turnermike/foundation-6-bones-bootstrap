...
// $result = preg_match('/0.0.0.0/', $server , $matches);
...
if(defined('ENVIRONMENT')){
    ...
    case 'development':
        ...
        define('WP_CONTENT_DIR', '/public_html/f6bb-content' ); // Do not remove. Removing this line could break your site. Added by Security > Settings > Change Content Directory.
        define('WP_CONTENT_URL', 'http://foundation-6-bones-bootstrap.dev/f6bb-content' ); // Do not remove. Removing this line could break your site. Added by Security > Settings > Change Content Directory.
        define('WP_HOME', 'http://foundation-6-bones-bootstrap.dev');
        define('WP_SITEURL', 'http://foundation-6-bones-bootstrap.dev');
